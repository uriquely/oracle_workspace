...
-- 국어국문학과의 학과번호는 001임을 확인

select student_name "학생 이름", absence_yn "휴학 여부(Y/N)"
from tb_student
...
-- 모든 교수들은 학과번호를 가지고 있으며, 이 번호가 null값이면 총장
...
--extract(year from entrance_date) = 2002 이렇게 찾는 게 정확하다.
